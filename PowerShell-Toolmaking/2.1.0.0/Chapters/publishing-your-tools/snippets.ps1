...
Copyright = '(c) 2020 Don Jones & Jeffery Hicks. All rights reserved.'

# Description of the functionality provided by this module
Description = "Sample for for 'The PowerShell Scripting and Toolmaking Book' by Don Jones and Jeffery Hicks."
